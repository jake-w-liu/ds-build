...
//!
//! Run with: cargo test -p ds-mcp --test repro_sse_flood -- --nocapture
...
use ds_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use ds_mcp::rmcp::ServiceExt;
use ds_mcp::rmcp::transport::StreamableHttpClientTransport;
use ds_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
