...
use crate::implementations::ds_build::task::types::SubagentCancelOutcome;
use crate::types::requirements::{Expr, ToolRequirement};
use crate::types::resources::Terminal;
use crate::types::template_renderer::TemplateRenderer;
use crate::types::tool::ToolKind;
use crate::types::tool::ToolNamespace;
use ds_tool_types::{KillTaskOutput, KillTaskResult, KillTaskToolInput};
...
impl crate::types::tool_metadata::ToolMetadata for KillTaskTool {
    ...
    fn description_template(&self) -> &str {
        ...
        // fallback mirrors the default ds-build toolset on the current OS.
        static DESC: std::sync::LazyLock<String> = std::sync::LazyLock::new(|| {
            ds_tool_types::build_kill_task_description(&ds_tool_types::KillTaskToolNaming {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        let task_tool = Expr::Value(ToolRequirement::Tool {
            ...
            id: ds_tool_runtime::Tool::id(&TaskTool).to_string(),
            if_params: None,
        });
        let mut arms =
            crate::implementations::ds_build::task_output::background_bash_requires_exprs();
        arms.push(task_tool);
        Expr::Or(arms)
    }
}
...
/// [`ds_tool_types::build_kill_task_description`] builder so the CLI and
...
impl ds_tool_runtime::Tool for KillTaskTool {
    type Args = KillTaskToolInput;
    type Output = KillTaskOutput;

    fn id(&self) -> ds_tool_protocol::ToolId {
        ds_tool_protocol::ToolId::new("kill_task").expect("valid tool id")
    }
    ...
    ) -> Result<KillTaskOutput, ds_tool_runtime::ToolError> {
...
mod tests {
    ...
    fn make_ctx_with_version(
        ...
        ctx.extensions
            .insert(ds_tool_runtime::BehaviorVersion(version.to_owned()));
        ctx
    }
    ...
    fn tool_name_and_description() {
        ...
        assert_eq!(ds_tool_runtime::Tool::id(&tool).as_str(), "kill_task");
