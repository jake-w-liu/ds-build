...
impl ds_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl ds_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> ds_tool_protocol::ToolId {
        ds_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, ds_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                ds_tool_runtime::ToolError::execution(
                    ds_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
