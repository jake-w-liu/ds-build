...
impl ds_tool_runtime::Tool for MemoryGetImpl {
    type Args = MemoryGetInput;
    type Output = ToolOutput;

    fn id(&self) -> ds_tool_protocol::ToolId {
        ds_tool_protocol::ToolId::new("memory_get").expect("valid tool id")
    }
        ...
        let content = memory
            ...
            .map_err(|e| {
                ds_tool_runtime::ToolError::execution(
                    ds_tool_protocol::ToolId::new("memory_get").expect("valid"),
