...
impl ds_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // DsBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::ds_build::read_file::ReadFileTool;
