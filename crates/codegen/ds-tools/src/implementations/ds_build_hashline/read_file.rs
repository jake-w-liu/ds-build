...
//!
//! Reuses the core file-reading logic from [`ds_build::read_file::run_read_file`]
...
use crate::implementations::ds_build::read_file::{ReadFileInput, run_read_file};
...
impl ds_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> ds_tool_protocol::ToolId {
        ds_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::ds_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    fn tool_metadata() {
        ...
        assert_eq!(ds_tool_runtime::Tool::id(&tool).as_str(), "hashline_read");
    ...
    /// file content independently of ds_build `read_file`).
    #[tokio::test]
