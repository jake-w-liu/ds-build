...
use crate::implementations::ds_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::ds_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::ds_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::ds_build::grep::GrepSearchInput;
use crate::implementations::ds_build::image_edit::ImageEditInput;
use crate::implementations::ds_build::image_gen::ImageGenInput;
use crate::implementations::ds_build::list_dir::ListDirInput;
use crate::implementations::ds_build::read_file::ReadFileInput;
use crate::implementations::ds_build::search_replace::SearchReplaceInput;
use crate::implementations::ds_build::todo::TodoWriteInput;
use crate::implementations::ds_build::update_goal::UpdateGoalInput;
use crate::implementations::ds_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::ds_build::web_fetch::WebFetchInput;
use crate::implementations::ds_build::web_search::WebSearchInput;
...
use ds_tool_types::KillTaskToolInput;
use ds_tool_types::TaskOutputToolInput;
use ds_tool_types::TaskToolInput;
use ds_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::ds_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::ds_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::ds_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::ds_build::scheduler::delete::SchedulerDeleteInput),
