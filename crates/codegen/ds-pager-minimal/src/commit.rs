...
use ds_pager::appearance::AppearanceConfig;
use ds_pager::minimal_api;
use ds_pager::render::Renderable;
use ds_pager::scrollback::block::RenderBlock;
use ds_pager::scrollback::blocks::ToolCallBlock;
use ds_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use ds_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                ds_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
