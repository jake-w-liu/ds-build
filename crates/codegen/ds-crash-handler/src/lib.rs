...
//! }
//!
//! ds_crash_handler::install(ds_crash_handler::CrashHandlerConfig {
...
/// `$DS_HOME` they must not be world-readable.
...
mod tests {
    ...
    fn check_previous_crash_returns_none_when_no_file() {
        let dir = PathBuf::from("/tmp/ds-crash-handler-test-nonexistent");
