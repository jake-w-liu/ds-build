//! ds-sampler - Actor-based sampling layer for DeepSeek ds.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `ds-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `ds-hunk-tracker`.
//!
//! ## Layered API
//!
