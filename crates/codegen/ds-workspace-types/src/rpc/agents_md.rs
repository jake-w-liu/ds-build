...
/// Claude.md / `.ds/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.ds` and compat dirs.
...
/// Mirrors the serde shape of `ds-agent`'s `AgentConfigFile`.
