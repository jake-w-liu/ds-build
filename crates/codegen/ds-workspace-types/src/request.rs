...
//!   here would force every consumer of `ds-workspace-types`
...
//! (`ds-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `ds-workspace-types`
