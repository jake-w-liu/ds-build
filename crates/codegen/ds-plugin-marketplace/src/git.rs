...
//! Cache root: `~/.ds/marketplace-cache/<url-hash>/`
...
pub fn default_cache_root() -> PathBuf {
    ds_config::ds_home().join("marketplace-cache")
}
...
mod tests {
    ...
    fn cache_hash_is_deterministic() {
        let url = "https://github.com/deepseek-ai/ds-plugin-marketplace.git";
    ...
    #[test]
    fn default_cache_root_under_ds() {
