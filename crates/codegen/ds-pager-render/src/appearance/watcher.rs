...
//!
//! In dev mode, watches ~/.ds/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.ds/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.ds/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = ds_config::user_ds_home()
