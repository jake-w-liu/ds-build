...
///
/// - `osc52_sink`: when `ds wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `ds wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `ds wrap` is the SSH path.
    #[test]
