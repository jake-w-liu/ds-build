//! DsNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// DsNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_dsnight_theme() {
        let theme = Theme::dsnight();
