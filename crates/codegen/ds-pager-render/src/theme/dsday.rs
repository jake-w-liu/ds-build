//! DsDay theme — neutral gray base (light) with deepened accent colors.
//!
//! Light counterpart to DsNight. Backgrounds and text use a neutral
//! grayscale ramp (no blue/warm tint). Accent colors are the same hue
//! family as DsNight but deepened for contrast on light backgrounds.
