...
//! Dark themes (DsNight, TokyoNight) share `ds-night.tmTheme`;
//! DsDay uses `ds-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use ds_markdown::Syntect;

use crate::theme::ThemeKind;

static SYNTECT_DSNIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_TOKYONIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_DSDAY: OnceLock<Syntect> = OnceLock::new();
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_DSNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/ds-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::DsDay => SYNTECT_DSDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/ds-day.tmTheme"))),
    }
}
