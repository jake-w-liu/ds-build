//! Public event types — the wire contract for `ds-fsnotify`.
//!
...
//! translator (in `ds-workspace`) maps these to
...
/// Aligned with `ds_workspace_types::FsEventKind` (identity map at
