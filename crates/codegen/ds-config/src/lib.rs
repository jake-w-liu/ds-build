//! Config file loading for DS.
//!
//! Merge order (lowest → highest priority):
//! 1. `/etc/ds/managed_config.toml`
//! 2. `$DS_HOME/managed_config.toml`
//! 3. `$DS_HOME/config.toml`
//! 4. `$DS_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/ds/requirements.toml`
//! 6. macOS MDM managed preferences (`ai.ds.cli`, admin-forced) — macOS only
//!
...
pub use paths::{
    ...
    default_ds_home, encode_cwd_dirname, ensure_sessions_cwd_dir, ds_application, ds_home,
    sessions_cwd_dir, system_config_dir, user_ds_home,
};
pub use validation::{
