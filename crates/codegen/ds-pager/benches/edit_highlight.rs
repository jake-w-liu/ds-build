...
//!
//! ```text
//! cargo bench -p ds-pager --bench edit_highlight
//! cargo bench -p ds-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use ds_pager::diff::{DiffHunk, DiffLine};
use ds_pager::scrollback::blocks::tool::{
...
use ds_pager::syntax::{Syntect, get_syntect};
