...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "deepseek-v4-flash", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "deepseek-v4-flash", "researcher");
    ...
    let shared_models = ["deepseek-v4-flash", "ds-3-mini"];
