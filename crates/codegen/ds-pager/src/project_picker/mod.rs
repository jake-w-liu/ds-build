...
pub mod detection {
    pub use ds_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;

use std::path::{Path, PathBuf};

use ds_tools::implementations::ds_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run DS Build in a project directory?\n\n\
                 This gives DS Build full context of your codebase for better results."
                .into(),
            id: None,
            options,
