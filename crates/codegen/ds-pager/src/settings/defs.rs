...
//
// Concrete codes must match `ds_voice::STT_LANGUAGES` (official DS STT
// catalog — https://api-docs.deepseek.com/).
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "dsnight".
                default: "dsnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "dsnight".
                default: "dsnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "dsday".
                default: "dsday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "ds", "switch"],
        ...
        // The `DS_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Controls whether DeepSeek may retain and train on coding session data.",
            keywords: &[
                "privacy",
                "data",
                "sharing",
        ...
        // follows the process locale when it maps to a DS STT language.
        // Catalog = official STT languages (see ds_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (DS STT). \
