...
//! render mode.
//!
//! `ds-pager` cannot depend on `ds-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`ds-pager-bin`) wires it up once at
//! startup by calling `ds_pager_minimal::install()`. When nothing has
