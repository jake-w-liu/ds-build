...
/// Online Build docs landing page (hardcoded like other TUI deep-links; api-docs.deepseek.com can redirect if the path moves).
pub const BUILD_DOCS_URL: &str = "https://api-docs.deepseek.com/";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.ds.cli/build in the browser".into(),
            },
        ];
