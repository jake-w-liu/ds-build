#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// and the shell emits the queue-emptying `ds.cli/queue/changed` right after
    ...
    /// `ds.cli/task_backgrounded` arriving after the skipped zero-work wait
    /// re-evaluates and restores the park.
    #[test]
    ...
    fn interjection_notification_pushes_block_to_matching_session() {
        ...
        // the shell as ds.cli/session/interjection; EVERY attached pane (incl.
