#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn ask_user_question_routes_to_background_session_not_active_view() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(ds_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("ds.cli/ask_user_question", raw.into()),
            response_tx: tx,
        });
    ...
    fn close_viewer_preserves_plan_approval_state() {
        ...
        handle(
            AcpClientMessage::ExtMethod(ds_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("ds.cli/exit_plan_mode", raw.into()),
                response_tx: tx,
            }),
            &mut app,
        );
