    ...
    fn goal_updated_ignores_unknown_json_fields_via_serde() {
        ...
        let raw_payload = serde_json::json!({
            ...
            "update": {
                ...
                "live_tokens_by_model": [["deepseek-v4-pro", 6_000], ["deepseek-v4-flash", 4_000]],
                "live_context_pct": 42,
                "live_turn_count": 7,
        ...
        let request = acp::ExtNotification::new("ds.cli/session_notification", raw.into());
        ...
        assert_eq!(
            ...
            vec![("deepseek-v4-pro".to_owned(), 6_000), ("deepseek-v4-flash".to_owned(), 4_000)],
