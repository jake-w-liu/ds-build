...
-> [ds_tools::implementations::ds_build::ask_user_question::QuestionOption; 2] {
    use ds_tools::implementations::ds_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `ds.cli/session/fork` directly.
