...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `ds.cli/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. DsNight's dark band leaking into DsDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default DsNight, dark) after the user switches —
        // painting a dark band on a light DsDay canvas.
