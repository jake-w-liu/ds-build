#
# DS CLI installer for PowerShell — https://www.deepseek.com/cli/install.ps1
#
...
#
# Usage:
#   irm https://www.deepseek.com/cli/install.ps1 | iex                                       # latest stable
#   & ([scriptblock]::Create((irm https://www.deepseek.com/cli/install.ps1))) -Version 0.1.42 # specific version
#   $env:DS_VERSION="0.1.42"; irm https://www.deepseek.com/cli/install.ps1 | iex           # specific version (alt)
#   $env:DS_DEPLOYMENT_KEY="<key>"; irm https://www.deepseek.com/cli/install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://www.deepseek.com/cli/install.sh | bash"
    exit 1
}
