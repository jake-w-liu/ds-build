#!/bin/bash
#
# DS CLI installer (enterprise channel) — https://www.deepseek.com/cli/enterprise-install.sh
#
...
#
# Usage:
#   curl -fsSL https://www.deepseek.com/cli/enterprise-install.sh | bash            # latest enterprise
#   curl -fsSL https://www.deepseek.com/cli/enterprise-install.sh | bash -s 0.1.42  # specific version
#   DS_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://www.deepseek.com/cli/enterprise-install.sh)
#
