...
Learn how to install, configure, and extend DS Build, the terminal-based AI coding assistant from DeepSeek.
...
Automate, script, and integrate DS Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `ds -p`, output formats, CI/CD integration, and piping |
