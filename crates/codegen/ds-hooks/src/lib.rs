//! # ds-hooks
//!
//! Runtime hook system for DS — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for DS. Hooks are discovered
//! from dedicated directories (`~/.ds/hooks/` and `<git-worktree-root>/.ds/hooks/`),
...
//!     Some(Path::new("/home/user/.ds/hooks")),
//!     Some(Path::new("/project/.ds/hooks")),
//! );
//!
//! for err in &errors {
