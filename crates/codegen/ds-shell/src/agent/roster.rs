...
//! two ways:
//!
//!   - request/response `ds.cli/sessions/list` → `{ "sessions": [RosterEntry, …] }`
//!   - broadcast notification `ds.cli/sessions/changed` →
...
/// Response payload for `ds.cli/sessions/list`.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
pub struct RosterListResponse {
    pub sessions: Vec<RosterEntry>,
}

/// Params payload for the `ds.cli/sessions/changed` broadcast notification.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
...
pub const SESSIONS_LIST_METHOD: &str = "ds.cli/sessions/list";
pub const SESSIONS_CHANGED_METHOD: &str = "ds.cli/sessions/changed";
