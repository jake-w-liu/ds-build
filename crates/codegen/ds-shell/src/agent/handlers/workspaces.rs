...
mod tests {
    ...
    #[test]
    fn success_response_projects_ds_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["ds.cli/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["ds.cli/partial"]["reason"], "no_oauth");
    }
}
