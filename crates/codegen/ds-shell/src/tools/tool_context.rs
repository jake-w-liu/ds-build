...
//! ds-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use ds_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use ds_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn ds_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<ds_tools::implementations::ds_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = ds_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
