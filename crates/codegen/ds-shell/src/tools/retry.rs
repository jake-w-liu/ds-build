//! Retry utilities — re-exported from `ds-tools`.
//!
//! The canonical implementation now lives in `ds_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use ds_tools::retry::BackoffConfig as RetryConfig;
pub use ds_tools::retry::{BackoffConfig, execute_with_backoff};
