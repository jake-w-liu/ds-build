...
fn discover_auto_sources(cwd: &str, skills: &[SkillInfo]) -> Vec<(String, usize)> {
    ...
    for subdir in &subdirs {
        try_add_source(ds_home.join(subdir), None);
    }
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "ds.cli/skills/add" => {
            ...
            .await
            {
                ds_telemetry::session_ctx::log_event(
                    ds_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            ds_telemetry::session_ctx::log_event(ds_telemetry::events::SkillAdded {
        ...
        "ds.cli/skills/remove" => {
            ...
            {
                ds_telemetry::session_ctx::log_event(
                    ds_telemetry::events::SkillRemoved { success: false },
                );
            ...
            ds_telemetry::session_ctx::log_event(ds_telemetry::events::SkillRemoved {
                success: true,
            });
