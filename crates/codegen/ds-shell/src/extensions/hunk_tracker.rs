...
//!
//! Provides access to the ds-hunk-tracker functionality for tracking file changes
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "ds.cli/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "ds.cli/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "ds.cli/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "ds.cli/hunk-tracker/file-action" => {
        ...
        "ds.cli/hunk-tracker/turn-action" => {
        ...
        "ds.cli/hunk-tracker/all-action" => {
