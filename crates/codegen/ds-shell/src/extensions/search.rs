...
use ds_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use ds_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "ds.cli/search/content" => {
            ...
            // `ds.cli/search/content/status` batches through the client sink.
