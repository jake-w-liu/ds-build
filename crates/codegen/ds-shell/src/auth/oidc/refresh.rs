...
use super::super::DsAuth;
use super::protocol::{OidcError, OidcUserInfo, build_ds_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &DsAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_ds_auth(tokens, user_info, issuer, client_id);
