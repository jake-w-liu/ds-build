...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<DsAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: DsAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, DsAuth, DsComConfig};
