...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&DsAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> ds_telemetry::events::AuthTokenKind {
        use ds_telemetry::events::AuthTokenKind as K;
        match self {
