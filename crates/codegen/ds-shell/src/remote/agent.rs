...
// Re-export sandbox API types from cli-proxy-types for convenience.
// Sorted alphabetically; see sandbox_types.rs for logical grouping.
pub use ds_cli_proxy_types::{
...
impl SandboxClient {
    ...
    async fn auth_headers(
        ...
        Ok(ds_file_utils::trace_context::inject_trace_context_into_request(builder))
    }
