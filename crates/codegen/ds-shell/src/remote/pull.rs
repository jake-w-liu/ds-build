...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* ds_home (where this hydrated copy lives),
            ...
            sandbox_profile: ds_sandbox::configured_profile_name().map(String::from),
    ...
    impl ChatReducer {
        ...
        fn process(
            ...
            match update {
                ...
                SessionUpdate::Ds(n) => self.handle_ds(&n.update),
            }
        }
        ...
        fn handle_ds(
            ...
            use crate::extensions::notification::SessionUpdate as DsUpdate;

            match update {
                DsUpdate::CompactionCheckpoint(_) => {
                    self.reset();
    ...
    const REPLAYABLE_METHODS: &[&str] = &["session/update", "_ds.cli/session/update"];
