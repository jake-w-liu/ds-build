...
//
// State is persisted to `~/.ds/claude_import_state.json`.
...
use ds_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.ds/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::ds_home::ds_home().join("claude_import_state.json")
}
