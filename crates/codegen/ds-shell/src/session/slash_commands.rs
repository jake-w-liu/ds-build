...
use ds_tools::implementations::skills::skill::format_skill_name;
...
// ── ds.cli/commands/list ext method ────────────────────────────────
...
pub(super) async fn build_skill_information_for_refs(
    ...
    use ds_tools::implementations::skills::skill::{
...
/// `ds-tools` so it stays identical to the pager's `LoopCommand` and the
