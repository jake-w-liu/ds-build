...
pub struct ClientFeedbackInput {
    ...
    pub client_type: ds_cli_proxy_types::feedback_types::ClientType,

    /// Rating type (thumbs, stars, nps)
    #[serde(default)]
    pub rating_type: Option<ds_cli_proxy_types::feedback_types::RatingType>,
    ...
    #[serde(default)]
    pub context_type: Option<ds_cli_proxy_types::feedback_types::ContextType>,
    ...
    #[serde(default)]
    pub terminal_info: Option<ds_cli_proxy_types::feedback_types::FeedbackTerminalInfo>,
}
...
impl ClientFeedbackInput {
    ...
    fn clamp_rating_value(
        rating_type: Option<ds_cli_proxy_types::feedback_types::RatingType>,
        rating_value: Option<i32>,
    ) -> Option<i32> {
        use ds_cli_proxy_types::feedback_types::RatingType;
    ...
    ) -> ds_cli_proxy_types::feedback_types::FeedbackSubmission {
        use ds_cli_proxy_types::feedback_types::FeedbackContent;
...
impl TokenUsageCategory {
    ...
    pub fn skills_listing(text: &str, skill_count: usize) -> Self {
        Self {
            ...
            tokens: ds_token_estimation::estimate_tokens(text),
...
pub struct ContextInfo {
    ...
    /// always matches the actual trigger (e.g. 65 for ds-build in remote settings).
...
impl ContextInfo {
    ...
    pub fn from_notification(used: u64, total: u64) -> Self {
        Self {
            used,
            total,
            usage_pct: ds_token_estimation::usage_percentage_u8(used, total),
            free_tokens: ds_token_estimation::free_tokens(total, used),
...
pub struct SessionInfoData {
    /// Agent definition name for this session (e.g. `ds-build`).
...
pub fn is_coding_model_slug(model: &str) -> bool {
    matches!(model, "ds-build" | "deepseek-v4-pro.5")
}
...
/// Full wire response for `ds.cli/session/info`.
///
...
pub struct FeedbackContext {
    ...
    pub tool_outcomes: Vec<ds_cli_proxy_types::feedback_types::FeedbackToolOutcome>,
...
mod tests {
    ...
    fn should_show_model_fingerprint_truth_table() {
        ...
        assert!(should_show_model_fingerprint(false, "ds-build"));
        assert!(should_show_model_fingerprint(false, "deepseek-v4-pro.5"));
    ...
    fn desktop_client_type_deserializes_and_round_trips() {
        ...
        assert_eq!(
            input.client_type,
            ds_cli_proxy_types::feedback_types::ClientType::Desktop
        );
        assert_eq!(input.session_id, "sess-1");

        let submission = input.to_submission(Some("deepseek-v4-flash".into()), None, None, Some(5));
        assert_eq!(
