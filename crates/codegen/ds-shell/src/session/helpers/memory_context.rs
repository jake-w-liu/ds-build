...
use ds_chat_state::{MEMORY_CONTEXT_CLOSE_TAG, MEMORY_CONTEXT_OPEN_TAG};
use ds_sampling_types::ConversationItem;
use ds_tools::types::memory_backend::{MemorySearchResult, format_staleness_note};
...
mod tests {
    ...
    fn test_format_memory_reminder_empty_results_is_none() {
        use ds_tools::types::memory_backend::MemorySearchResult;
