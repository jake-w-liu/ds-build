...
use ds_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use ds_mcp::servers as inner;
...
pub fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    ds_file_utils::events::Event::McpConfigResolved { servers, disabled }
}
