//! Feedback request heuristics for DS Code sessions.
//!
...
impl FeedbackHeuristics {
    ...
    pub fn new() -> Self {
        Self {
            ...
            tier1_prompt:
                "You've been using DS Code productively! Would you mind sharing quick feedback?"
                    .to_string(),
    ...
    pub fn from_config(config: &FeedbackHeuristicsConfig) -> Self {
        use ds_cli_proxy_types::feedback_types::parse_feedback_mode_str;
...
impl FeedbackRequest {
    ...
    pub fn with_mode(
        ...
        let prompt = match prompt_override {
            ...
            _ => match tier {
                FeedbackTier::Tier1 => {
                    "You've been using DS Code productively! Would you mind sharing quick feedback?".to_string()
                }
                FeedbackTier::Tier2 => {
