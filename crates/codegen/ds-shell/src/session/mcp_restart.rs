...
//! window containing a [`ds_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`ds_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`ds_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`ds_mcp::servers::ClientStateKind::Empty`]
...
use ds_mcp::servers::{McpClientEventKind, McpServerName};
...
pub trait RestartActions {
    ...
    /// Push an already-built `ds.cli/mcp/server_status` payload to the
...
/// ACP `ds.cli/mcp/server_status` notification. Failures are logged and
