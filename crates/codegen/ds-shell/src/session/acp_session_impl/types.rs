...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<ds_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(ds_tools::implementations::ds_build::update_goal::UpdateGoalInput),
    Channel(ds_tools::implementations::ds_build::update_goal::UpdateGoalEnvelope),
}
