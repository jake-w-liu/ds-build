...
async fn persist_ack_waits_for_disk_flush_before_success() {
    ...
    local
        .run_until(async {
            ...
            let sampling_client = crate::sampling::Client::new(ds_sampler::SamplerConfig {
...
/// user's next queued prompt) and rebroadcasts `ds.cli/queue/changed`. The
    ...
    local
        .run_until(async {
            ...
            actor.chat_state_handle.push_assistant_response(
                ConversationItem::assistant_tool_calls(vec![ds_sampling_types::ToolCall {
                    id: "call-1".into(),
    ...
    local
        .run_until(async {
            ...
            let cfg = ds_sampler::SamplerConfig {
                ...
                temperature: None,
                top_p: None,
                api_backend: ds_sampler::ApiBackend::Responses,
                auth_scheme: Default::default(),
                extra_headers: Default::default(),
                context_window: 100_000,
                client_version: None,
...
async fn skill_reminder_deferred_while_turn_running_flushed_when_idle() {
    use ds_tools::types::skill_discovery_tracker::{SkillUpdateEffects, SkillUpdateKind};
        ...
        actor
            ...
            .filter(|item| {
                matches!(
                    ...
                    matches!(p, ds_sampling_types::ContentPart::Text { text } if
