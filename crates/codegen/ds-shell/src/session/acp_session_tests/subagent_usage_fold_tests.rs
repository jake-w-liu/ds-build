...
fn usage_rows() -> Vec<(String, ds_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        ds_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use ds_tools::implementations::ds_build::task::types::SubagentOutstandingReply;
...
> {
    use ds_tools::implementations::ds_build::task::types::SubagentEvent;
