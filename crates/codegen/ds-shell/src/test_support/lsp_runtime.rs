...
use ds_tools::implementations::ds_build::task::types::{SubagentRequest, SubagentResult};
pub(crate) type GatewayOut = <acp::AgentSide as ds_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(ds_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-ds-test"),
        ...
        parent_skills: None,
        parent_skills_config: ds_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: ds_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: ds_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl ds_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &ds_tools::implementations::lsp::LspToolInput,
    ) -> ds_tools::implementations::lsp::LspToolResult {
        ds_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<ds_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<ds_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
