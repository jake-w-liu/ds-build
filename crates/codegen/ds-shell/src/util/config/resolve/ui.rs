...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "DS_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`DS_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "DS_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`DS_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "DS_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`DS_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `DS_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("DS_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes DS_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
