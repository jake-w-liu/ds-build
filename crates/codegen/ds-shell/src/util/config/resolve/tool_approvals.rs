...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "DS_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`DS_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `DS_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
