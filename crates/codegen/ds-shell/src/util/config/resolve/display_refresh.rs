...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "DS_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "DS_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`DS_MIN_DRAW_MS` / `DS_SCROLL_CADENCE_MS`).
