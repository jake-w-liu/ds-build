//! DS Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.deepseek.com/v1/stt` and `wss://api.deepseek.com/v1/stt`.
//!
...
/// Official DS STT languages (api-docs.deepseek.com), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from api-docs.deepseek.com supported languages"
        );
    }
