...
//! DS to persist important information across sessions. Memory files are
//! stored under `~/.ds/memory/` with workspace-scoped subdirectories
...
//! `DS_MEMORY=1` environment variable. When disabled, this crate
