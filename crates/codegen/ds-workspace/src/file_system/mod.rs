...
// its wire types live in `ds_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use ds_workspace_types::rpc::fs::FsReadEncoding;
...
pub use ds_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
