...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `ds-tool-runtime`. Sampler-side wire
...
/// `ds_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<ds_tool_types::ToolDescription>,
}
