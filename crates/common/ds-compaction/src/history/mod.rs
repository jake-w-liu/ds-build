...
//! string/text manipulation. Harness-bound extraction (DS chat's
//! `DsConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `DsMessage` assembly) stays in the harness crate.
