...
/// Numeric JSON-RPC code for overload rejection (`ds-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "DS_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `DS_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
