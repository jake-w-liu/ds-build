//! Unified MCP adapter for the DeepSeek Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](ds_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](ds_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
