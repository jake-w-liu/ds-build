...
/// `filename`, `path`, `metadata`) that the DS SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the DS SLOP converter to
    ...
    /// - `path`: file path on the DS Computer filesystem
