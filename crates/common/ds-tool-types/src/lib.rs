...
pub use task::{
    ATTACKER_CODE_PROMPT, ATTACKER_CODE_SUBAGENT, ATTACKER_MATH_PROMPT, ATTACKER_MATH_SUBAGENT,
    ATTACKER_RESEARCH_PROMPT, ATTACKER_RESEARCH_SUBAGENT, BUILTIN_SUBAGENTS, BuiltinSubagent,
    EXPLORE_PROMPT, EXPLORE_SUBAGENT, GENERAL_PURPOSE_PROMPT, GENERAL_PURPOSE_SUBAGENT,
    KillTaskOutput, KillTaskResult, KillTaskToolInput, KillTaskToolNaming, MAX_MULTI_WAIT_IDS,
    ...
    format_subagent_completed, format_subagent_started_background, is_not_sentinel, resolve_task_ids,
    sanitize_optional_arg, task_output_waits, task_output_waits_from_json,
};
pub use types::{
