...
fn map_block(block: ds_tool_protocol::McpBlock) -> ContentBlock {
    use ds_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: ds_tool_protocol::JsonRpcError) -> ToolError {
